...
//------------------------------------------------------------------------------
/* Scaling of potency with local magnitude */
double Earthquake::localMagnitude()
{
  /* Scaling Relations of Trugman and Ben-Zion (2024) */
  double a = 0.14731;
  double b = 0.02689;
  double c = -2.00364 - log10( potency() /(Units::km*Units::km*Units::cm));
